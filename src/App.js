import './App.css';
import {SimpsonsFamily} from "./components/SimpsonsFamily/simpsons_family"
import './components/SimpsonsFamily/simpsons_family.css'

const App = () => {
    return (
        <div className="App">
            <h1 className={'title'}>Simpson family</h1>
            <img src="https://static.wikia.nocookie.net/simpsons/images/6/63/The_Simpsons_Simpsons_FamilyPicture.png" alt="The_Simpsons_Family"/>
